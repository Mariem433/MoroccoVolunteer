            ...
            try {
               ...
               if (conn != null) {
                    out.println("<nav class=\"navbar navbar-light navbar-expand-lg fixed-top bg-white clean-navbar\">\n" +
                            ...
                            "                    <li class=\"nav-item\"><a class=\"nav-link\" href=\"features.html\">Events</a></li>\n" +
...
"                                            <form><select class=\"form-control\" style=\"height: 32px;padding-top: 8px;padding-bottom: 3px;font-size: 12px;width: 102%;margin-right: 2px;margin-bottom: 0px;margin-left: -9px;\">\n" +
"                                                    <option value=\"2\" selected=\"\">All</option>\n" +
"                                                    <option value=\"1\">Available for at least 1 event</option>\n" +
"                                                    <option value=\"0\">Not available</option>\n" +
"                                                </select><button class=\"btn btn-primary\" type=\"button\" style=\"margin-top: 10px;padding-top: 3px;color: var(--blue);background: var(--white);margin-right: 11px;margin-bottom: 0px;\">Button</button>\n" +
"                                            </form>\n" +
"                                        </div>");
...
"                                                <div class=\"input-group-append\"><button class=\"btn btn-warning\" type=\"button\"><i class=\"fa fa-search\"></i></button></div>\n" +
"                                            </div>\n" +
"                                        </form>\n" +
"                                    </div>\n" +
"                                </div>");
                    ...
                    ResultSet rst = stmt.executeQuery("SELECT V.volunteerID, firstname, lastname,  \n" +
                                                        "CAST(COALESCE(AVG(volunteerRating),0) AS decimal(8,2))AS \"Average Rating\" \n" +
                    ...
                    while (rst.next()) {
                        ...
                        out.println("<div class=\"product-name\"><a href=\"#\">"+rst.getString(2)+" "+rst.getString(3)+"</a></div>");
