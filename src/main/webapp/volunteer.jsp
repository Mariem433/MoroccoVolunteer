...
<html>
    ...
    <%
        ...
        int volId = (int)session.getAttribute("id");
    %>
    <body>
        ...
        <%try {
            ...
            if (ds != null) {
                ...
                String qry = "SELECT * FROM vwVolWithAvgRate WHERE volunteerId = (?);";
                ...
                Date birthdate = rst1.getDate(4);
                String gender = rst1.getString(5);
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="info">
                                        ...
                                        <%
                                        String qry2 = "SELECT numEventsVolunteer (?)";
                                        ...
                                        %>
                                        <div class="price">
                                            <h3>Past Events : <%=rst2.getInt(1)%></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="product-info">
                            <div>
                                <ul class="nav nav-tabs" role="tablist" id="myTab">
                                    <li class="nav-item" role="presentation"><a class="nav-link active" role="tab" data-toggle="tab" id="description-tab" href="#description">Applications</a></li>
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active description" role="tabpanel" id="description">
                                        ...
                                        <tbody>
                                            <%  String qry3 = "SELECT * from vwApplicationWithOrg WHERE volunteerId = (?)";
                                            ...
                                            <tr>
                                                ...
                                                <% if(rst3.getString(5).equals("pending")){%>
                                                   <td><a class="nav-link" href=".\cancelApplication">cancel</a></li></td> 
                                                <%}else{%>
                                                <<td></td>
                                                <%}%>
                                            </tr>
                                    ...
                                    <div class="tab-pane fade specifications" role="tabpanel" id="specifications">
                                        <div class="table-responsive table-bordered">
                                            <table class="table table-bordered">
                                                <tbody>
                                                    <tr>
                                                        <td class="stat">First Name</td>
                                                        <td><%=firstname%></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="stat">Last Name</td>
                                                        <td><%=lastname%></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="stat">Birth Date</td>
                                                        <td><%=birthdate%></td>
                                                    </tr>
                                                    <tr>
                                    ...
                                    <div class="tab-pane fade" role="tabpanel" id="reviews">
                                        <%  String qry4 = "SELECT * from vwratingswithOrgauthor WHERE volunteerId = (?)";
                                                ...
                                                <div class="reviews">
                                                    <div class="review-item">
                                                        <div class="rating"><%=rst4.getInt(3)%>/10</div>
                                                        <span class="text-muted"><a href="#"><%=rst4.getString(2)%></a></span>
                                                        <%
                                                        if(rst4.getString(4) == null ||rst4.getString(4).length()==0 ){
                                                        %>
                                                        <p>No Comment</p>
                                                        <%}else{%>
                                                        <p><%=rst4.getString(4)%></p>
                                                        <%}%>
                                                    </div>
                                                </div>
                                        <%}%>
